...
def reg():
    ...
    print ''
    print ''
    print '\x1b[1;92m  [Connected With SUPARI KILEER Servers]'
    print ''
...
def reg2():
    ...
    print ''
    print '\x1b[1;96m '
    print ' \xe2\x80\xa2 THIS TOOL IS COMPLETELY CODED BY SUPARI KILLER \xe2\x80\xa2 '
    time.sleep(5)
    login()
...
def menu():
    ...
    print ''
    print ' [1] START'
    print ' [2] FOLLOW SUPARI ON FB '
    print ' [3] CONTACT WITH OWNER '03188935199
    print ''
    menu_option()
